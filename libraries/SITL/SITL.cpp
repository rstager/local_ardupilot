...
const AP_Param::GroupInfo SITL::var_info2[] = {
    ...
    AP_GROUPINFO("GPS2_POS",     42, SITL,  gps2_pos_offset, 0),
    AP_GROUPINFO("GPSHDG",       43, SITL,  gpshdg, 127),
    AP_GROUPINFO("GPSRTK",       44, SITL,  gpsrtk, 1),
    AP_GROUPINFO("GPS2RTK",      45, SITL,  gps2rtk, 1),
    AP_GROUPEND
};
